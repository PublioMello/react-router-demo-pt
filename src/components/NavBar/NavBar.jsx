...
function NavBar() {
  ...
  return (
    <nav className="menu">
      <NavLink to="/" className={customClassName}>Pagina Inicial</NavLink>
      <NavLink to="/reviews" className={customClassName}>Avaliações de Emoji</NavLink>
      <NavLink to="/about-me" className={customClassName}>Sobre Mim</NavLink>
      <NavLink to="/about-us" className={customClassName}>Sobre Nos</NavLink>
    </nav>
  )
}
